...
export default class streetElementNode {
  constructor(id, coordenate, layer) {
    ...
    const feature = new Feature({
      // The feature
      geometry: new Point(fromLonLat([coordenate[0], coordenate[1]])),
    });
    ...
    this.setCoordinates = (lonLat) => {
      ...
      feature.getGeometry().setCoordinates(fromLonLat([lonLat[0], lonLat[1]]));
      this.getConnections().forEach((conn) => conn.update()); // Update link
    };
