...
export default class streetElementAgency {
  constructor(id, name, url, timezone, lang, phone, fare_url, email) {
    this.getID = () => id;
  ...
  static isInstance(obj) {
    ...
    console.log(
      "The variable is not a " + streetElementAgency.name + " instance"
    );
    return false;
  }
}
