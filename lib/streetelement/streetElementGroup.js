...
`;
    ...
    this.updatePopup = () => {
      if (this.getLastSelectedNode() != null) {
        ...
        el_popup_node_id.innerText =
          "Node ID: " + this.getLastSelectedNode().getID();
        el_popup_node_type.innerText =
          "Node Type: " + this.getLastSelectedNode().getType();
        el_popup_node_connections.innerText =
          "Node Connections: " +
          this.getLastSelectedNode().getConnections().length;
        el_popup_node_lat.innerText =
          "Latitude: " +
          this.getLastSelectedNode().getLonLat()[1].toPrecision(8);
        el_popup_node_long.innerText =
          "Longitude: " +
          this.getLastSelectedNode().getLonLat()[0].toPrecision(8);
