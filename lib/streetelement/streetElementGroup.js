...
export default class streetElementGroup {
  ...
  constructor(params) {
    if (params.center instanceof Array && params.center.length == 1) {
...
parent_station,stop_timezone,wheelchair_boarding".split(
  ...
  setNodeCoordinatesByID(node_id, coordinates) {
    // External
    ...
    this.historyPush(["setNodeCoordinatesByID", node_id, coordinates]);
