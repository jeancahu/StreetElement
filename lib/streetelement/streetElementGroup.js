...
`;
      ...
      el_map_menu.innerHTML = `
            ...
            <div class="se_menu_box">
                <button>Hide Nodes</button>
                <button>Hide Links</button>
                <button>Hide Stops</button>
            </div>
`;
...
`;
  ...
  <div id="popup-content">
    ...
    <select
      ...
      name="ol_node_type"
    >
      <option value="fork">Intersection</option>
...
`;
      ...
      el_popup.childNodes[1].onclick = function () {
        map.getOverlayById("popup_node_info").setPosition(undefined);
        el_popup.childNodes[1].blur();
        return false;
      };
    };
